...
>
> This mod is currently unmaintained. The default branch preserves **RWFAC
> 0.2.4**, the last known working release for **TFM2 0.5.8** and its legacy
> Mod SDK. It is not supported or verified on TFM2 0.6.0.
>
> Experimental and incomplete TFM2 0.6.0 Stable API work is preserved on
> [`recovery/tfm2-0.6.0-compat`](https://github.com/MadManPetr1/tfm2-real-world-free-agent-cleanup/tree/recovery/tfm2-0.6.0-compat).
...
> SDK and retesting cleanup behavior on disposable career copies before release.
